    ...
    for link in partner_data.get("partner_flagship_links", []):
        if clean_text(link.get("flagship_id", "")) in member_ids:
            links.append({
                ...
                "call_ids": project.get("call_ids", []),
                "call_names": project.get("call_names", []),
...
def build_campus_dashboard_data(applicants, flagship_data, partner_data):
    ...
    for _, row in mapping.iterrows():
        ...
        projects.append({
            ...
            "call_ids": split_semicolon_values(dashboard_item.get("call_id", "")),
            "call_names": split_semicolon_values(dashboard_item.get("call_name", "")),
